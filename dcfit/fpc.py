...
from dcfit.common.distance import euclidean_distance, squared_distance
from dcfit.common.partition import Partition, voronoi_partition
...
def farthest_point_clustering(
    ...
    p = voronoi_partition(data[center_idxs, :], data)
    if return_center_idxs:
        return p, center_idxs
    return p
