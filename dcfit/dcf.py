...
from dcfit.common.estimator import EstimatorModel, Estimator
from dcfit.common.regression import prepare_prediction, postprocess_prediction
from dcfit.optim.socprog import (
    socp_solve, SOCP_BACKEND__LBFGS, convert_matrix_to_socp_solver_format,
    socp_nonnegative_cone, socp_second_order_cone,
)
from dcfit.common.distance import euclidean_distance
from dcfit.common.partition import (
    Partition, voronoi_partition, cell_radii, find_closest_centers,
)
from dcfit.fpc import (
...
def _local_optim(opt_type, maxiter, lbfgs_memsize, noise_level,
    ...
    if model.is_mma():
        from dcfit.optim_task import SmoothMaxMinAffineOptimTask
        if model.is_symmetrized:
        ...
        if opt_type == 'nonsmooth':
            from dcfit.optim_task import NonSmoothDCFLocalOptimTask
            ...
            from dcfit.optim_task import SmoothDCFLocalOptimTask
    ...
    from dcfit.optim.lbfgs import LBFGS
